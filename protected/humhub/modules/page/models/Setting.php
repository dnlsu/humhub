...
/**
 * Page settings compatiblity layer class
 *
...
class Setting
{
     ...
     * @param type $moduleId
     */
    public static function Set($pageId, $name, $value, $moduleId = '')
    {
        $user = Page::findOne(['id' => $pageId]);
     ...
     * @return string
     */
    public static function Get($page, $name, $moduleId = '', $defaultValue = '')
    {
        $user = Page::findOne(['id' => $page]);
