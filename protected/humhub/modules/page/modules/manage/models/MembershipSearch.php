...
class MembershipSearch extends Membership
{
    ...
    public function search($params)
    {
        ...
        $query->andWhere(['page_membership.status' => $this->status]);
        $query->joinWith([
            'user',
            'user.profile',
        ...
        if (!empty($this->group_id)) {
            $query->andFilterWhere(['page_membership.group_id' => $this->group_id]);
        }
