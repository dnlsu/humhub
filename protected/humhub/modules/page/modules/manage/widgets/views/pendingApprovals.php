...
<div class="panel panel-danger">
    <div class="panel-heading"><?= Yii::t('PageModule.base', '<strong>New</strong> member request'); ?></div>
            ...
            <?php foreach ($applicants as $membership) : ?>
                ...
                <tr>
                    ...
                    <td align="left" valign="top">
                        ...
                        <hr>
                        <?= Link::success(Yii::t('PageModule.base', 'Accept'))->post($page->createUrl('/page/manage/member/approve-applicant', ['userGuid' => $user->guid]))->sm() ?>
                        <?= Link::danger(Yii::t('PageModule.base', 'Decline'))->post($page->createUrl('/page/manage/member/reject-applicant', ['userGuid' => $user->guid]))->sm() ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </table>
