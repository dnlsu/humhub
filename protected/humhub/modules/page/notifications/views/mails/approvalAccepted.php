            ...
            <td style="padding-top:10px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="left">
                    <tr>
                        ...
                        <td width="109"></td>
                        <td width="50"><?= \humhub\widgets\mails\MailContentContainerImage::widget(['container' => $page])?></td>
                        <td></td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td>
                ...
                \humhub\widgets\mails\MailButtonList::widget(['buttons' => [
                        humhub\widgets\mails\MailButton::widget(['url' => $url, 'text' => Yii::t('PageModule.notification', 'View Online')])
                ]]);
