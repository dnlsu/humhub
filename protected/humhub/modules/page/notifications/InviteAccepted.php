...
/**
 * PageInviteAcceptedNotification is sent to the originator of the invite to
...
class InviteAccepted extends BaseNotification
{
    ...
    {
        return Yii::t('PageModule.notification', '{displayName} accepted your invite for the page {spaceName}', [
