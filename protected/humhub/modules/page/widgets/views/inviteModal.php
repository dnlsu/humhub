...
/* @var $model \humhub\modules\page\models\forms\InviteForm */
...
$modal = ModalDialog::begin([
    'header' => Yii::t('PageModule.base', '<strong>Invite</strong> members'),
]);
        ...
        <?php if ($canInviteExternal) : ?>
            <div class="<?= $isInviteExternalTabActiveClass ?> tab-pane" id="external">
                ...
                <?= $form->field($model, 'inviteExternal')->textarea([
                    'id' => 'page-invite-external',
                    'rows' => '3',
                    'placeholder' => Yii::t('PageModule.base', 'Email addresses'),
                ]); ?>
            </div>
        <?php endif; ?>
