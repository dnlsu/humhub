...
use humhub\modules\page\widgets\Comment;
use humhub\modules\page\widgets\Form;
use yii\helpers\Url;
    ...
    <div class="comment <?php if (Yii::$app->user->isGuest): ?>guest-mode<?php endif; ?>"
        ...
        <?php if ($isLimited): ?>
            <a href="#" class="show show-all-link" data-ui-loader data-action-click="comment.showAll"
               data-action-url="<?= Url::to(['/page/comment/show', 'objectModel' => $objectModel, 'objectId' => $objectId]) ?>">
