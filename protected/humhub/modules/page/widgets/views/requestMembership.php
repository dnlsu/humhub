<div id="lightbox_requestWorkspace">
    ...
    <div class="panel panel_lightbox">
        <div class="content content_innershadow">
            ...
            <h2><?= Yii::t('PageModule.base', 'Request workspace membership'); ?></h2>

            <p><?= Yii::t('PageModule.base', 'Please shortly introduce yourself, to become a approved member of this workspace.'); ?></p>
            <br><br>
            ...
            <div class="form">
                ...
                <div class="row_lightbox buttons">
                    ...
                    <?= CHtml::ajaxButton(Yii::t('PageModule.base', 'Send'), ['workspace/requestMembershipForm', 'guid'=> $workspace->guid], [
                        'type' => 'POST',
                        'beforeSend' => 'function() {
                    ...
                    <?= CHtml::link(Yii::t('PageModule.base', 'Cancel'), '#', ['onclick'=>'RequestWorkspacebox.close()', 'class' => 'button', 'style' => 'color: #fff;']); ?>
