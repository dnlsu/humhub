 ...
 */
return [
    '<b>This page is still empty!</b>' => '<b>Это пространство по прежнему пусто!</b>',
    '<b>This page is still empty!</b><br>Start by posting something here...' => '<b>Это пространство ещё пусто!</b><br>Начните разместив что-нибудь здесь...',
    '<b>You are not member of this page and there is no public content, yet!</b>' => '<b>Вы не участник данного пространства, общедоступных материалов пока нет!</b>',
    ...
    '<strong>Request</strong> page membership' => '<strong>Отправить</strong> запрос на вступление',
    '<strong>Page</strong> followers' => 'Подписчики <strong>пространства</strong>',
    '<strong>Page</strong> members' => '<strong>Участники</strong>',
    '<strong>Page</strong> menu' => '<strong>Меню</strong> пространства',
    'Accept' => 'Активировать',
    ...
    'My Page List' => 'Мои пространства',
    'My page summary' => 'Сводка пространства',
    'Name' => 'Наименование',
    'New user by e-mail (comma separated)' => 'Новые пользователи по e-mail (через запятую)',
    'New user?' => 'Новый пользователь?',
    'No pages found.' => 'Пространства не найдены.',
    ...
    'Please shortly introduce yourself, to become an approved member of this page.' => 'Представьтесь, чтобы стать участником этого пространства.',
    'Posts' => 'Сообщений',
    'Private' => 'Приватно',
    ...
    'Sorry, you are not allowed to leave this page!' => 'Извините, вам не разрешено покинуть это пространство',
    'Page' => 'Пространства',
    'Page directory' => 'Директория пространства',
    'Page is invisible!' => 'Пространство скрыто!',
    'Pages' => 'Пространства',
    'Status' => 'Статус',
    'Stream' => 'Активность',
    'Tags' => 'Теги',
    ...
    'To invite users to this page, please type their names below to find and pick them.' => 'Для приглашения пользователей в это пространство, пожалуйста введите их имена ниже.',
    'Unfollow' => 'Отписаться',
    ...
    'You are not allowed to join this page!' => 'Вы не можете присоединиться к этому пространству!',
    ...
    'You cannot create private visible pages!' => 'Вы не можете создавать приватные пространства!',
    'You cannot create public visible pages!' => 'Вы не можете создавать публичные пространства!',
    'You need to login to view contents of this page!' => 'Вы должны зарегистрироваться, чтобы посмотреть содержимое этого пространства!',
    'Your request was successfully submitted to the page administrators.' => 'Ваша заявка на вступление в это пространство успешно отправлена',
