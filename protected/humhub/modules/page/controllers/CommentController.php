...
use humhub\modules\page\widgets\Comment as CommentWidget;
...
class CommentController extends Controller
{
    ...
    public function actionShow()
    {
        ...
        $pagination = new Pagination([
            ...
            'pageSize' => Yii::$app->getModule('comment')->commentsBlockLoadSize,
        ]);
        ...
        if (Yii::$app->request->get('mode') == 'popup') {
            return $this->renderAjax('showPopup', [
                'object' => $this->target, 'output' => $output, 'id' => $this->content->getUniqueId(),
            ]);
        } else {
    ...
    {
        if (Yii::$app->user->isGuest || !Yii::$app->getModule('comment')->canComment($this->target)) {
